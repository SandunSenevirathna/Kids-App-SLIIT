...
const ColourObjectSelectGameHistory = ({ navigation }) => {
  ...
  return (
    <ImageBackground
      ...
      resizeMode="cover"
    >
      <Text style={styles.Title}> Colour Object Select Game History</Text>
...
export default ColourObjectSelectGameHistory;
