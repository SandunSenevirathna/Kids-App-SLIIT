...
const ANEXIETY_MideScreen = ({ navigation, route }) => {
  ...
  return (
    ...
    >
      <View>
        <View>
          <Text style={styles.gameName}>ANEXIETY Next Step</Text>
        </View>
        ...
        >
          ...
          <RoundedButton
            title={"Continue"}
            onPress={() =>
              navigation.navigate("ANEXIETY_Levels", { predictionMessage })
            }
          />
        </View>
      </View>
...
export default ANEXIETY_MideScreen;
