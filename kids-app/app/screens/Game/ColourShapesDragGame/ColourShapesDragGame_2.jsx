...
const images = {
    image1: require('../../../assets/S3.png'),
    image2: require('../../../assets/S2.png'),
    image3: require('../../../assets/S4.png'),
    image4: require('../../../assets/S1.png'),
};

const holes = {
    hole1: require('../../../assets/S3.png'),
    hole2: require('../../../assets/S2.png'),
    hole3: require('../../../assets/S4.png'),
    hole4: require('../../../assets/S1.png'),
};
...
const ColourShapesDragGame_2 = ({ navigation, route }) => {
    ...
    useEffect(() => {
        if (pressedNextButton && (correctRoundsPlayed !== 0 || incorrectRoundsPlayed !== 0)) {
            setTimeout(() => {
                ...
                navigation.navigate('ColourShapesDragGame_3', {
                    startTime: startTime,
...
export default ColourShapesDragGame_2;
